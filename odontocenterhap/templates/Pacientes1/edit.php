...
<div class="container mt-5 mb-4">
    ...
    <?= $this->Form->create($pacientes1, ['class' => 'row g-3']) ?>
    ...
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('apellido', ['label' => 'Apellido', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.fecha_nacimiento', ['label' => 'Fecha de Nacimiento', 'id' => 'fecha-nacimiento','type' => 'date', 'class' => 'form-control', 'max' => date('Y-m-d'), 'value' => $pacientes1->paciente->fecha_nacimiento ?? null]) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.dni', ['label' => 'DNI', 'class' => 'form-control' , 'pattern' => '[0-9]{0,20}', 'title' => 'Debe ser un número de 8 dígitos', 'value' => $pacientes1->paciente->dni ?? null]) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.ruc', ['label' => 'RUC', 'class' => 'form-control', 'pattern' => '[0-9]{11}', 'title' => 'Debe ser un número de 11 dígitos', 'value' => $pacientes1->paciente->ruc ?? null]) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.sexo', [
            'label' => 'Sexo',
            'type' => 'select',
            'empty' => 'Seleccione una opción',
            'options' => ['M' => 'Masculino', 'F' => 'Femenino'],
            'class' => 'form-control',
            'value' => $pacientes1->paciente->sexo ?? null,
        ]) ?>
    </div>

    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.edad', ['label' => 'Edad', 'class' => 'form-control', 'type' => 'number',
        'min' => '0',
        'title' => 'Solo se permiten números enteros positivos',
        'id' => 'edad',
        'readonly' => true, 'value' => $pacientes1->paciente->edad ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.nombre_apoderado', ['label' => 'Nombre del Apoderado', 'class' => 'form-control', 'value' => $pacientes1->paciente->nombre_apoderado ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.parentesco_apoderado', ['label' => 'Parentesco del Apoderado', 'class' => 'form-control', 'value' => $pacientes1->paciente->parentesco_apoderado ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.direccion', ['label' => 'Dirección', 'class' => 'form-control', 'value' => $pacientes1->paciente->direccion ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.distrito', ['label' => 'Distrito', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.codigo_postal', ['label' => 'Código Postal', 'class' => 'form-control', 'pattern' => '[0-9]+', 'title' => 'Debe ser un número válido', 'value' => $pacientes1->paciente->codigo_postal ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.email', ['label' => 'Email', 'class' => 'form-control', 'value' => $pacientes1->paciente->email ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.telefono_oficina', ['label' => 'Teléfono Oficina', 'class' => 'form-control', 'pattern' => '[0-9]+', 'title' => 'Solo se permiten números', 'value' => $pacientes1->paciente->telefono_oficina ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('telefono_celular', ['label' => 'Teléfono Celular', 'class' => 'form-control', 'pattern' => '[0-9]+', 'title' => 'Solo se permiten números', 'value' => $pacientes1->telefono_celular ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.centro_trabajo', ['label' => 'Centro de Trabajo', 'class' => 'form-control', 'value' => $pacientes1->paciente->centro_trabajo ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.centro_estudio', ['label' => 'Centro de Estudio', 'class' => 'form-control', 'value' => $pacientes1->paciente->centro_estudio ?? null]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.recomendacion', ['label' => 'Recomendado por:', 'class' => 'form-control', 'value' => $pacientes1->paciente->recomendacion ?? null]) ?>
    </div>
...
<div class="container mt-4">
    ...
    <?php foreach ($pacientes1->paciente->contactos_emergencia as $index => $contacto): ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <?= $this->Form->control("contactos_emergencia.{$index}.medico_confianza", [
                        ...
                        'value' => $contacto->medico_confianza ?? null,
                        'class' => 'form-control',
                    ]) ?>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <?= $this->Form->control("contactos_emergencia.{$index}.servicio_ambulancia", [
                        ...
                        'value' => $contacto->servicio_ambulancia ?? null,
                        'class' => 'form-control',
                    ]) ?>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <?= $this->Form->control("contactos_emergencia.{$index}.nombre_contacto", [
                        ...
                        'value' => $contacto->nombre_contacto ?? null,
                        'class' => 'form-control',
                    ]) ?>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <?= $this->Form->control("contactos_emergencia.{$index}.telefono_contacto", [
                        ...
                        'value' => $contacto->telefono_contacto ?? null,
                        'class' => 'form-control',
                    ]) ?>
                </div>
            </div>
    ...
    <details class="border p-3 mb-3">
        ...
        <fieldset class="mt-3">
            <div id="enfermedades-container">
                ...
                <?php foreach ($pacientes1->paciente->enfermedades_actuales as $index => $enfermedad): ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("enfermedades_actuales.{$index}.enfermedad", [
                                    'label' => 'Enfermedad',
                                    'value' => $enfermedad->enfermedad ?? null,
                                    'type' => 'textarea',
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("enfermedades_actuales.{$index}.tiempo_enfermedad", [
                                    ...
                                    'value' => $enfermedad->tiempo_enfermedad ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("enfermedades_actuales.{$index}.sintomas_principales", [
                                    ...
                                    'value' => $enfermedad->sintomas_principales ?? null,
                                    'type' => 'textarea',
                                    'class' => 'form-control textarea-adjust',
                                    'style' => 'height: 38px;',
                                ]) ?>
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("enfermedades_actuales.{$index}.created", [
                                    ...
                                    'value' => $enfermedad->created->format('Y-m-d H:i') ?? null,
                                    'type' => 'text',
                                    'class' => 'form-control',
    ...
    <details class="border p-3 mb-3">
        ...
        <fieldset id="antecedentes-medicos-section" class="mt-3">
            <div id="antecedentes-medicos-container">
                ...
                <?php foreach ($pacientes1->paciente->antecedentes_medicos as $index => $antecedente): ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.alergias", [
                                    'label' => 'Alergias',
                                    'value' => $antecedente->alergias ?? null,
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.medicacion", [
                                    'label' => 'Medicación',
                                    'value' => $antecedente->medicacion ?? null,
                                    'type' => 'text', // Se asegura que sea un input normal
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.nombre_medico", [
                                    'label' => 'Médico',
                                    'value' => $antecedente->nombre_medico ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.telefono_medico", [
                                    'label' => 'Teléfono',
                                    'value' => $antecedente->telefono_medico ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.tipo_hepatitis", [
                                    ...
                                    'value' => $antecedente->tipo_hepatitis ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.diabetes_estado", [
                                    ...
                                    'value' => $antecedente->diabetes_estado ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.condicion_cardiaca", [
                                    ...
                                    'value' => $antecedente->condicion_cardiaca ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.tratamiento_cardiaco", [
                                    ...
                                    'value' => $antecedente->tratamiento_cardiaco ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->control("antecedentes_medicos.{$index}.enfermedad_riesgo", [
                                    ...
                                    'value' => $antecedente->enfermedad_riesgo ?? null,
                                    'type' => 'text', // Se asegura que sea un input normal
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
    ...
    <details class="border p-3 mb-3">
        ...
        <fieldset id="antecedentes-odontologicos-section" class="mt-3">
            <div id="antecedentes-odontologicos-container">
                ...
                <?php foreach ($pacientes1->paciente->antecedentes_odontologicos as $index => $antecedente): ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.motivo_consulta", [
                                    ...
                                    'value' => $antecedente->motivo_consulta ?? null,
                                    'type' => 'text', // Se asegura que sea un input normal
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.frecuencia_visita", [
                                    ...
                                    'value' => $antecedente->frecuencia_visita ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.experiencia_traumatica", [
                                    ...
                                    'value' => $antecedente->experiencia_traumatica ?? null,
                                    'type' => 'text', // Se asegura que sea un input normal
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.extracciones_dentales", [
                                    ...
                                    'value' => $antecedente->extracciones_dentales ?? null,
                                    'type' => 'text', // Se asegura que sea un input normal
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.complicaciones_anestesia", [
                                    ...
                                    'value' => $antecedente->complicaciones_anestesia ?? null,
                                    'type' => 'text', // Se asegura que sea un input normal
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.fecha_ultima_profilaxis", [
                                    ...
                                    'value' => $antecedente->fecha_ultima_profilaxis ?? null,
                                    'class' => 'form-control',
                                    'max' => date('Y-m-d'),
                                ]) ?>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->control("antecedentes_odontologicos.{$index}.satisfaccion_dental", [
                                    ...
                                    'value' => $antecedente->satisfaccion_dental ?? null,
                                    'class' => 'form-control',
                                ]) ?>
                            </div>
                        </div>
