...
echo "=== BLOQUES EN AGENDAMIENTO ===\n\n";

$result = $mysqli->query("
    SELECT block_key, block_type, content, is_active
    FROM content_blocks
    WHERE section_id = (SELECT id FROM content_sections WHERE slug = 'agendamiento')
    ORDER BY sort_order
");
...
if ($result && $result->num_rows > 0) {
    ...
    echo "No hay bloques configurados para Agendamiento\n";
}
