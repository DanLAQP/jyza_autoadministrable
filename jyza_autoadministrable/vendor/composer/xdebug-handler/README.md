...
[![Continuous Integration](REMOVED/composer/xdebug-handler/actions/workflows/continuous-integration.yml/badge.svg?branch=main)](REMOVED/composer/xdebug-handler/actions?query=branch:main)
