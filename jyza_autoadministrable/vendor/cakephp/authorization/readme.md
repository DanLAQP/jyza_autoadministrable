...
![Build Status](REMOVED/cakephp/authorization/actions/workflows/ci.yml/badge.svg?branch=master)
...
packaged into a separate [authentication plugin](REMOVED/cakephp/authentication).
