...
<div class="container mt-5 mb-4">
    ...
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('nombre', ['label' => 'Nombre', 'class' => 'form-control', 'required' => true]) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('apellido', ['label' => 'Apellido', 'class' => 'form-control', 'required' => true]) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.dni', ['label' => 'DNI/Carnet/Pasaporte', 'class' => 'form-control', 'pattern' => '^[0-9]{0,20}$', 'title' => 'Debe ser un número de 8 o 20 dígitos', 'required' => true]) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.ruc', ['label' => 'Ruc', 'class' => 'form-control', 'pattern' => '[0-9]{11}', 'title' => 'Debe ser un número de 11 dígitos']) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.fecha_nacimiento', ['label' => 'Fecha de Nacimiento', 'type' => 'date', 'class' => 'form-control', 'max' => date('Y-m-d'), 'id' => 'fecha-nacimiento']) ?>
    </div>
    <div class="col-md-3 mb-3">
    ...
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.edad', ['label' => 'Edad', 'class' => 'form-control', 'readonly' => true, 'id' => 'edad']) ?>
    </div>

    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.nombre_apoderado', ['label' => 'Nombre del Apoderado', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.parentesco_apoderado', ['label' => 'Parentesco del Apoderado', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.direccion', ['label' => 'Dirección', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.distrito', ['label' => 'Distrito', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.codigo_postal', ['label' => 'Código Postal', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.email', ['label' => 'Email', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('paciente.telefono_oficina', ['label' => 'Teléfono Oficina', 'class' => 'form-control', 'pattern' => '[0-9]+', 'title' => 'Solo se permiten números']) ?>
    </div>
    <div class="col-md-3 mb-3">
        <?= $this->Form->control('telefono_celular', ['label' => 'Teléfono Celular', 'class' => 'form-control', 'pattern' => '[0-9]+', 'title' => 'Solo se permiten números']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.centro_trabajo', ['label' => 'Centro de Trabajo', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.centro_estudio', ['label' => 'Centro de Estudio', 'class' => 'form-control']) ?>
    </div>
    <div class="col-md-6 mb-3">
        <?= $this->Form->control('paciente.recomendacion', ['label' => 'Recomendado por:', 'class' => 'form-control']) ?>
    </div>
</div>
        ...
        <fieldset class="mt-3">
            <div id="contactos-emergencia-container">
                <div class="contacto-emergencia">
                    <div class="row g-3">
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.contactos_emergencia.0.medico_confianza', [
                                'label' => 'Médico de Confianza',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.contactos_emergencia.0.servicio_ambulancia', [
                                'label' => 'Servicio de Ambulancia',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.contactos_emergencia.0.nombre_contacto', [
                                'label' => 'Nombre del Contacto',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.contactos_emergencia.0.telefono_contacto', [
                ...
                <div class="enfermedad-actual">
                    <div class="row g-3">
                        <div class="col-md-12 mb-3">
                            <?= $this->Form->control('paciente.enfermedades_actuales.0.enfermedad', [
                                'label' => 'Enfermedad',
                                'type' => 'textarea',
                        ...
                        <div class="col-md-12 mb-3">
                            <?= $this->Form->control('paciente.enfermedades_actuales.0.tiempo_enfermedad', [
                                'label' => 'Tiempo de Enfermedad',
                                'class' => 'form-control',
                            ]) ?>
                        </div>
                        <div class="col-md-12 mb-3">
                            <?= $this->Form->control('paciente.enfermedades_actuales.0.sintomas_principales', [
            ...
            <div id="antecedentes-medicos-container">
                <div class="antecedente-medico">
                    ...
                    <div class="row g-3">
                        <!-- Alergias -->
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.alergias]', [
                                'label' => 'Alergias',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        ...
                        <!-- Medicación -->
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.medicacion]', [
                                'label' => 'Medicación',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        ...
                        <!-- Médico -->
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.nombre_medico]', [
                                'label' => 'Médico',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        ...
                        <!-- Teléfono -->
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.telefono_medico]', [
                                'label' => 'Teléfono',
                                'class' => 'form-control'
                            ]) ?>
                        </div>
                        ...
                        <!-- Tipo de Hepatitis -->
                        <div class="col-md-12 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.tipo_hepatitis]', [
                        ...
                        <!-- Estado de Diabetes -->
                        <div class="col-md-12 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.diabetes_estado]', [
                        ...
                        <!-- condicion_cardiaca -->
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.condicion_cardiaca]', [
                        ...
                        <div class="col-md-6 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.tratamiento_cardiaco]', [
                        ...
                        <div class="col-md-12 mb-3">
                            <?= $this->Form->control('paciente.antecedentes_medicos.0.enfermedad_riesgo]', [
        ...
        <div id="antecedentes-odontologicos-container">
            <div class="antecedente-odontologico">
                ...
                <div class="row g-3">
                    <!-- Motivo de Consulta -->
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.motivo_consulta]', [
                    ...
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.frecuencia_visita]', [
                    ...
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.experiencia_traumatica]', [
                    ...
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.extracciones_dentales]', [
                    ...
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.complicaciones_anestesia]', [
                    ...
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.fecha_ultima_profilaxis]', [
                            'type' => 'date',
                    ...
                    <!-- Satisfacción Dental -->
                    <div class="col-md-6 mb-3">
                        <?= $this->Form->control('paciente.antecedentes_odontologicos.0.satisfaccion_dental]', [
