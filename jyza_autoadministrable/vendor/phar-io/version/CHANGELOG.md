...
- [#28](REMOVED/phar-io/version/issues/28): `VersionConstraintParser` does not support logical OR represented by single pipe (|) (Thanks @llaville)
...
- [#24](REMOVED/phar-io/version/issues/24): `Version::getOriginalString()` added (Thanks @addshore)
...
- [#23](REMOVED/phar-io/version/pull/23): Tilde operator without patch level
...
- [#22](REMOVED/phar-io/version/pull/22): make dev suffix rank works for uppercase too
...
- [#11](REMOVED/phar-io/version/issues/11): Added support for pre-release version suffixes. Supported values are:
  - `dev`
...
- [#10](REMOVED/phar-io/version/issues/10): Version numbers containing 
a numeric suffix as seen in Debian packages are now supported.  


[3.1.0]: REMOVED/phar-io/version/compare/3.0.4...3.1.0
[3.0.4]: REMOVED/phar-io/version/compare/3.0.3...3.0.4
[3.0.3]: REMOVED/phar-io/version/compare/3.0.2...3.0.3
[3.0.2]: REMOVED/phar-io/version/compare/3.0.1...3.0.2
[3.0.1]: REMOVED/phar-io/version/compare/3.0.0...3.0.1
[3.0.0]: REMOVED/phar-io/version/compare/2.0.1...3.0.0
[2.0.1]: REMOVED/phar-io/version/compare/2.0.0...2.0.1
[2.0.0]: REMOVED/phar-io/version/compare/1.0.1...2.0.0
