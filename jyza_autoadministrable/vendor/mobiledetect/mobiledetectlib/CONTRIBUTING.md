...
### 1. [Fork](https://help.REMOVED/articles/fork-a-repo/#fork-an-example-repository) the repo

```bash
git clone REMOVED/[yourname]/Mobile-Detect.git
git add remote serbanghita REMOVED/serbanghita/Mobile-Detect.git
git remote -v
...
origin       git@REMOVED:serbanghita/Mobile-Detect.git
serbanghita  REMOVED/serbanghita/Mobile-Detect.git
```
...
If you add new regexes make sure you commit the User-Agents in [`tests/providers/vendors`](REMOVED/serbanghita/Mobile-Detect/tree/master/tests/providers/vendors).
...
Now go to your repo on GitHub and ["Submit the PR"](https://help.REMOVED/articles/about-pull-requests/).
