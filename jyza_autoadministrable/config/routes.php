...
return function (RouteBuilder $routes): void {
    ...
    // API endpoint for content sections (JSON)
    $routes->connect('/api/content/section/:slug', ['controller' => 'ContentApi', 'action' => 'section'])
        ->setPass(['slug'])
    ...
    // Admin prefixed routes removed — using role-based access and main controllers instead.
