...
[![Latest Stable Version](http://poser.pugx.org/phpcsstandards/php_codesniffer/v)](REMOVED/PHPCSStandards/PHP_CodeSniffer/releases)
[![Validate](REMOVED/PHPCSStandards/PHP_CodeSniffer/actions/workflows/validate.yml/badge.svg?branch=master)](REMOVED/PHPCSStandards/PHP_CodeSniffer/actions/workflows/validate.yml)
[![Test](REMOVED/PHPCSStandards/PHP_CodeSniffer/actions/workflows/test.yml/badge.svg?branch=master)][GHA-test]
...
[![License](http://poser.pugx.org/phpcsstandards/php_codesniffer/license)](REMOVED/PHPCSStandards/PHP_CodeSniffer/blob/master/licence.txt)
...
[GHA-test]: REMOVED/PHPCSStandards/PHP_CodeSniffer/actions/workflows/test.yml

</div>

> [!NOTE]
> This package is the official continuation of the now abandoned [PHP_CodeSniffer package which was created by Squizlabs](REMOVED/squizlabs/PHP_CodeSniffer).
...
PHP_CodeSniffer requires PHP version 5.4.0 or greater, although individual sniffs may have additional requirements such as external applications and scripts. See the [Configuration Options manual page](REMOVED/PHPCSStandards/PHP_CodeSniffer/wiki/Configuration-Options) for a list of these requirements.

If you're using PHP_CodeSniffer as part of a team, or you're running it on a [CI](https://en.wikipedia.org/wiki/Continuous_integration) server, you may want to configure your project's settings [using a configuration file](REMOVED/PHPCSStandards/PHP_CodeSniffer/wiki/Advanced-Usage#using-a-default-configuration-file).
...
```bash
git clone REMOVED/PHPCSStandards/PHP_CodeSniffer.git
cd PHP_CodeSniffer
php bin/phpcs -h
php bin/phpcbf -h
```
...
Full usage information and example reports are available on the [usage page](REMOVED/PHPCSStandards/PHP_CodeSniffer/wiki/Usage).

## Documentation

The documentation for PHP_CodeSniffer is available on the [GitHub wiki](REMOVED/PHPCSStandards/PHP_CodeSniffer/wiki).

## Issues

Bug reports and feature requests can be submitted on the [GitHub Issue Tracker](REMOVED/PHPCSStandards/PHP_CodeSniffer/issues).
