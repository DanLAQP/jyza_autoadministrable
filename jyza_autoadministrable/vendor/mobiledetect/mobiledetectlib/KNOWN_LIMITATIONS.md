...
* Ipad 2019 is being recognized as a desktop because of Safari's default `Request Desktop Website` setting. See details and possible workaround [#820](REMOVED/serbanghita/Mobile-Detect/issues/820)
  * Also see [#886](REMOVED/serbanghita/Mobile-Detect/issues/886#issuecomment-1047187763) 
* Some touchscreen devices (eg. Microsoft Surface) are tough to detect as mobile since they can be used in a laptop mode. See: [#32](REMOVED/serbanghita/Mobile-Detect/issues/32), [#461](REMOVED/serbanghita/Mobile-Detect/issues/461), [#667](REMOVED/serbanghita/Mobile-Detect/issues/667)
* Some mobile devices (eg. IPadOS, Google Pixel Slate). See: [#795](REMOVED/serbanghita/Mobile-Detect/issues/795), [#788](REMOVED/serbanghita/Mobile-Detect/issues/788)
