...
[![Build status](REMOVED/slevomat/coding-standard/workflows/Build/badge.svg?branch=master)](REMOVED/slevomat/coding-standard/actions?query=workflow%3ABuild+branch%3Amaster)
...
Slevomat Coding Standard for [PHP_CodeSniffer](REMOVED/PHPCSStandards/PHP_CodeSniffer) provides sniffs that fall into three categories:
...
Sniffs in this standard marked by the 🔧 symbol support [automatic fixing of coding standard violations](REMOVED/PHPCSStandards/PHP_CodeSniffer/wiki/Fixing-Errors-Automatically). To fix your code automatically, run phpcbf instead of phpcs:
...
This project adheres to a [Contributor Code of Conduct](REMOVED/slevomat/coding-standard/blob/master/CODE_OF_CONDUCT.md). By participating in this project and its community, you are expected to uphold this code.
