...
The library that is developed in this repository was either extracted from [PHPUnit](REMOVED/sebastianbergmann/phpunit) or developed specifically as a dependency for PHPUnit.
