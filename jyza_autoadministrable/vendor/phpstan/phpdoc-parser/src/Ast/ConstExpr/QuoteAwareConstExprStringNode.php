...
class QuoteAwareConstExprStringNode extends ConstExprStringNode implements ConstExprNode
{
	...
	public function __toString(): string
	{
		if ($this->quoteType === self::SINGLE_QUOTED) {
			// from REMOVED/nikic/PHP-Parser/blob/0ffddce52d816f72d0efc4d9b02e276d3309ef01/lib/PhpParser/PrettyPrinter/Standard.php#L1007
			return sprintf("'%s'", addcslashes($this->value, '\'\\'));
		}

		// from REMOVED/nikic/PHP-Parser/blob/0ffddce52d816f72d0efc4d9b02e276d3309ef01/lib/PhpParser/PrettyPrinter/Standard.php#L1010-L1040
