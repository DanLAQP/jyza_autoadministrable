        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->pacientes1->nombre) ? h($paciente->pacientes1->nombre) : '&nbsp;' ?> <?= !empty($paciente->pacientes1->apellido) ? h($paciente->pacientes1->apellido) : '&nbsp;' ?></div>
                    </div>
                </div>
                <!-- Campo: RUC -->
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->ruc) ? h($paciente->ruc) : '&nbsp;' ?></div>
                    </div>
                </div>
                <!-- Campo: DNI -->
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->dni) ? h($paciente->dni) : '&nbsp;' ?></div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->fecha_nacimiento) ? h($paciente->fecha_nacimiento->format('d-m-Y')) : '&nbsp;' ?></div>
                    </div>
                </div>
                <!-- Campo: Sexo -->
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->sexo) ? h($paciente->sexo) : '&nbsp;' ?></div>
                    </div>
                    <div class="col-md-1"></div>
                    <!-- Campo: Edad -->
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->edad) ? h($paciente->edad) : '&nbsp;' ?></div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->direccion) ? h($paciente->direccion) : '&nbsp;' ?></div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->distrito) ? h($paciente->distrito) : '&nbsp;' ?></div>
                    </div>
                    <div class="col-md-1">  </div>
                    <!-- Campo: Código Postal -->
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->codigo_postal) ? h($paciente->codigo_postal) : '&nbsp;' ?></div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->nombre_apoderado) ? h($paciente->nombre_apoderado) : '&nbsp;' ?></div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->parentesco_apoderado) ? h($paciente->parentesco_apoderado) : '&nbsp;' ?></div>
                    </div>
                </div>
                <!-- campo email -->
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->email) ? h($paciente->email) : '&nbsp;' ?></div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->pacientes1->telefono_celular) ? h($paciente->pacientes1->telefono_celular) : '&nbsp;' ?></div>
                    </div>
                    <div class="col-md-1"></div>
                    ...
                    <div class="col-md-3">
                        <div class="data-box"><?= !empty($paciente->telefono_oficina) ? h($paciente->telefono_oficina) : '&nbsp;' ?></div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->centro_trabajo) ? h($paciente->centro_trabajo) : '&nbsp;' ?></div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->centro_estudio) ? h($paciente->centro_estudio) : '&nbsp;' ?></div>
                    </div>
                </div>
                <!-- Campo: Recomendacion -->
                <div class="row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="data-box"><?= !empty($paciente->recomendacion) ? h($paciente->recomendacion) : '&nbsp;' ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container mt-5">
    <div class="card shadow">
        ...
        <div class="card-body">
            <?php if (!empty($paciente->registros_tratamientos)) : ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center align-middle">
                        ...
                        <tbody>
                            <?php foreach ($paciente->registros_tratamientos as $index => $registro): ?>
                                <tr>
    ...
    <div class="card shadow">
        ...
        <div class="mb-3 text-end">
            <?= $this->Html->link(
                ...
                ['controller' => 'RegistrosConsultas', 'action' => 'add', $paciente->id],
                ['class' => 'btn btn-info openModal', 'target' => '_blank']
            ) ?>
        </div>
        <div class="card-body">
            <?php if (!empty($paciente->registros_consultas)) : ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center align-middle">
                        <thead class="table-dark">
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($paciente->registros_consultas as $registro): ?>
                                <tr>
                                    <td>
                                        <?= $registro->doctore ? 
                                    ...
                                    <td class="text-end fw-bold">
                                        S/. <?= number_format($registro->_total_costo, 2) ?> <!-- Usamos el total calculado -->
                                    </td>
                                    <td>
        ...
        <div class="card-body">
            ...
            <div class="mb-3 text-end">
                <?= $this->Html->link(
                    ...
                    ['controller' => 'Odontograma', 'action' => 'add', $paciente->id],
                    ['class' => 'btn btn-info openModal', 'target' => '_blank']
                ) ?>
            </div>
            <?php if (!empty($paciente->odontogramas_asociados)) : ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center align-middle">
                        <thead class="table-dark">
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($paciente->odontogramas_asociados as $odontograma): ?>
                                <tr>
...
<div id="archivos" class="container mt-5">
    <div class="card shadow">
        ...
        <div class="mb-3 text-end">
            <?= $this->Html->link(
                __('Agregar Archivo'),
                ['controller' => 'ArchivosPacientes', 'action' => 'add', $paciente->id],
                ['class' => 'btn btn-info openModal', 'target' => '_blank']
            ) ?>
        </div>

            <?php if (!empty($paciente->archivos_pacientes)) : ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center align-middle">
                        <thead class="table-dark">
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($paciente->archivos_pacientes as $archivo): ?>
                                <tr>
    ...
    <div class="card shadow">
        ...
        <div class="mb-3 text-end">
            <?= $this->Html->link(
                ...
                ['controller' => 'Presupuestos', 'action' => 'add', $paciente->id],
                ['class' => 'btn btn-info openModal', 'target' => '_blank']
            ) ?>
        </div>
        </div>
        <div class="card-body">
            <?php if (!empty($paciente->presupuestos)) : ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered text-center align-middle">
                        <thead class="table-dark">
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($paciente->presupuestos as $presupuesto): ?>
                                <?php 
