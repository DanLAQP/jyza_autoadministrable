<?php
// Script para actualizar todos los endpoints de secciones para incluir is_active
...
foreach ($endpoints as $slug) {
    $file = "C:\\xampp\\htdocs\\jyza_autoadministrable\\jyza_autoadministrable\\webroot\\api\\content\\section\\$slug\\index.php";
    $content = str_replace('{SLUG}', $slug, $template);
    file_put_contents($file, $content);
    echo "✅ Actualizado: $slug\n";
}

echo "\n✅ Todos los endpoints han sido actualizados.\n";
?>
