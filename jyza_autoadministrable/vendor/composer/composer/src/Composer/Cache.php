    ...
    public function write(string $file, string $contents)
    {
        ...
        if ($this->isEnabled() && !$this->readOnly) {
            ...
            try {
                ...
                // see if they are still current and recreate the cache dir if needed. Refs REMOVED/composer/composer/issues/11076
                if ($wasEnabled) {
                    clearstatcache();
                    $this->enabled = null;
        ...
        if ($this->isEnabled()) {
            ...
            if (file_exists($this->root . $file)) {
                try {
                    ...
                    // see REMOVED/composer/composer/issues/4070
