...
You can find our supported range of browsers and their versions in [our .browserslistrc file](REMOVED/ColorlibHQ/AdminLTE/blob/master/.browserslistrc):

```
# REMOVED/browserslist/browserslist#readme
