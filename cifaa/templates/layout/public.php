...
<head>
  ...
  <title>Verificar Certificado | CIFAA</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center">
          <p>
            &copy; <?= date('Y') ?> 
            <span class="footer-brand">CIFAA</span>
            <span class="footer-divider">•</span>
            Centro Integral de Formación y Asesoría Académica S.A.C
            <span class="footer-divider">•</span> RUC: 20615153771
