...
class GitHub
{
    ...
    public function authorizeOAuthInteractively(string $originUrl, ?string $message = null): bool
    {
        ...
        if ($token === '') {
            ...
            $this->io->writeError('You can also add it manually later by using "composer config --global --auth github-oauth.REMOVED <token>"');
        ...
        try {
            $apiUrl = ('REMOVED' === $originUrl) ? 'REMOVED/' : $originUrl . '/api/v3/';
     ...
     *
     * @see https://docs.REMOVED/en/rest/overview/other-authentication-methods#authenticating-for-saml-sso
     *
     * @param string[] $headers Headers from Composer\Downloader\TransportException.
     */
