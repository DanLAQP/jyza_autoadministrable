...
* [#31](REMOVED/sebastianbergmann/php-timer/issues/31): Type Error on 32-bit systems (where `hrtime()` returns `float` instead of `int`)
...
* Improved the fix for [#30](REMOVED/sebastianbergmann/php-timer/issues/30) and restored usage of `hrtime()`

## [3.1.1] - 2020-04-17

### Fixed

* [#30](REMOVED/sebastianbergmann/php-timer/issues/30): Resolution of time returned by `Timer::stop()` is different than before (this reverts using `hrtime()` instead of `microtime()`)
...
* [#21](REMOVED/sebastianbergmann/php-timer/pull/21): Formatting of memory consumption does not work on 32bit systems
...
[7.0.1]: REMOVED/sebastianbergmann/php-timer/compare/7.0.0...7.0.1
[7.0.0]: REMOVED/sebastianbergmann/php-timer/compare/6.0...7.0.0
[6.0.0]: REMOVED/sebastianbergmann/php-timer/compare/5.0.3...6.0.0
[5.0.3]: REMOVED/sebastianbergmann/php-timer/compare/5.0.2...5.0.3
[5.0.2]: REMOVED/sebastianbergmann/php-timer/compare/5.0.1...5.0.2
[5.0.1]: REMOVED/sebastianbergmann/php-timer/compare/5.0.0...5.0.1
[5.0.0]: REMOVED/sebastianbergmann/php-timer/compare/4.0.0...5.0.0
[4.0.0]: REMOVED/sebastianbergmann/php-timer/compare/3.1.4...4.0.0
[3.1.4]: REMOVED/sebastianbergmann/php-timer/compare/3.1.3...3.1.4
[3.1.3]: REMOVED/sebastianbergmann/php-timer/compare/3.1.2...3.1.3
[3.1.2]: REMOVED/sebastianbergmann/php-timer/compare/3.1.1...3.1.2
[3.1.1]: REMOVED/sebastianbergmann/php-timer/compare/3.1.0...3.1.1
[3.1.0]: REMOVED/sebastianbergmann/php-timer/compare/3.0.0...3.1.0
[3.0.0]: REMOVED/sebastianbergmann/php-timer/compare/2.1.2...3.0.0
[2.1.2]: REMOVED/sebastianbergmann/php-timer/compare/2.1.1...2.1.2
[2.1.1]: REMOVED/sebastianbergmann/php-timer/compare/2.1.0...2.1.1
[2.1.0]: REMOVED/sebastianbergmann/php-timer/compare/2.0.0...2.1.0
[2.0.0]: REMOVED/sebastianbergmann/php-timer/compare/1.0.9...2.0.0
