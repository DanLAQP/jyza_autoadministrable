        ...
        <div class="alert alert-info mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 text-muted">Editando contenidos de lecciones de este curso</p>
                </div>
                <?= $this->Html->link(
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h2 class="text-info mb-0">
                <i class="fas fa-file-alt"></i> Contenidos de Lección
                <?php if (isset($curso)): ?>
                    <span class="badge bg-info"><?= count($contenidosLeccion) ?></span>
                <?php endif; ?>
            </h2>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="text-center text-muted mt-2">
                            ...
                            <?= $this->Paginator->counter('Página {{page}} de {{pages}}, mostrando {{current}} contenido(s) de {{count}} totales') ?>
                        </p>
                    </div>
                </div>
            </div>
