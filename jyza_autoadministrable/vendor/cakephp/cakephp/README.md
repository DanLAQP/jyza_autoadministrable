...
recommend using the [app skeleton](REMOVED/cakephp/app) as
...
For details on the (minimum/maximum) PHP version see [version map](REMOVED/cakephp/cakephp/wiki#version-map).
...
* [Awesome CakePHP](REMOVED/FriendsOfCake/awesome-cakephp) - A curated list of featured resources around the framework.
...
* [GitHub Issues](REMOVED/cakephp/cakephp/issues) - Got issues? Please tell us!
* [Roadmaps](REMOVED/cakephp/cakephp/wiki#roadmaps) - Want to contribute? Get involved!
