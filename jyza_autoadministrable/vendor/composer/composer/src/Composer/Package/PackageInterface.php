...
interface PackageInterface
{
    ...
    /**
     * Returns the repository url of this package, e.g. git://REMOVED/naderman/composer.git
     *
    ...
    /**
     * Returns the repository urls of this package including mirrors, e.g. git://REMOVED/naderman/composer.git
     *
     * @return list<string>
     */
