...
is out of scope for this library. If you need something like that check out [Vars](REMOVED/m1/Vars) which incorporates
this library so you can load Env and other file types if you want, or checkout [PHP Dotenv](REMOVED/josegonzalez/php-dotenv)
