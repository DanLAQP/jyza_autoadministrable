...
return [
    ...
    'App' => [
        ...
        'defaultLocale' => env('APP_DEFAULT_LOCALE', 'es_PE'), // Cambia a es_PE para español en Perú
        'defaultTimezone' => env('APP_DEFAULT_TIMEZONE', 'America/Lima'), // Configura la zona horaria para Perú
        'base' => false,
        'dir' => 'src',
        'webroot' => 'webroot',
        'wwwRoot' => WWW_ROOT,
        //'baseUrl' => env('SCRIPT_NAME'),
        'fullBaseUrl' => env('FULL_BASE_URL', 'http://localhost:8000'),
        'imageBaseUrl' => 'img/',
        'cssBaseUrl' => 'css/',
        'jsBaseUrl' => 'js/',
        'paths' => [
     ...
     *   See REMOVED/cakephp/cakephp/issues/6471 for details.
    ...
    'Session' => [
        'defaults' => 'database',
        'timeout' => 240,         // Tiempo de inactividad en minutos
        'cookieTimeout' => 240,   // Tiempo de vida de la cookie (en minutos)
    ],
    'DebugKit' => [
     ...
     */
    'Cifa' => [
        'whatsapp_admin' => '51954957633', // CAMBIAR por número real
