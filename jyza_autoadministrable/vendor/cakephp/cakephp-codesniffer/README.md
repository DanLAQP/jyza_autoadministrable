...
![Build Status](REMOVED/cakephp/cakephp-codesniffer/actions/workflows/ci.yml/badge.svg?branch=master)
...
This code works with [squizlabs/php_codesniffer](REMOVED/squizlabs/PHP_CodeSniffer)
...
See [version map](REMOVED/cakephp/cakephp-codesniffer/wiki).
...
the [`dealerdirect/phpcodesniffer-composer-installer`](REMOVED/Dealerdirect/phpcodesniffer-composer-installer)
