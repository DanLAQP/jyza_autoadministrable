...
strategy, but also appeared in the [`2.x` branch](REMOVED/reactphp/promise/tree/2.x):
...
See [`2.x` CHANGELOG](REMOVED/reactphp/promise/blob/2.x/CHANGELOG.md) for more details.

## 1.0.0 (2012-11-07)

See [`1.x` CHANGELOG](REMOVED/reactphp/promise/blob/1.x/CHANGELOG.md) for more details.
