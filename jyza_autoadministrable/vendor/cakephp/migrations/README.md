...
[![CI](REMOVED/cakephp/migrations/actions/workflows/ci.yml/badge.svg)](REMOVED/cakephp/migrations/actions/workflows/ci.yml)
...
This branch is for use with CakePHP **5.x**. See [version map](REMOVED/cakephp/migrations/wiki#version-map) for details.
