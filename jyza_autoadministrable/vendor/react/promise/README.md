...
[![CI status](REMOVED/reactphp/promise/workflows/CI/badge.svg)](REMOVED/reactphp/promise/actions)
...
[read this first](https://gist.REMOVED/domenic/3889970).
...
[`2.x` branch](REMOVED/reactphp/promise/tree/2.x) (PHP 5.4+) or
[`1.x` branch](REMOVED/reactphp/promise/tree/1.x) (PHP 5.3+) which both
...
Promise is a port of [when.js](REMOVED/cujojs/when)
by [Brian Cavalier](REMOVED/briancavalier).

Also, large parts of the documentation have been ported from the when.js
[Wiki](REMOVED/cujojs/when/wiki) and the
[API docs](REMOVED/cujojs/when/blob/master/docs/api.md).
