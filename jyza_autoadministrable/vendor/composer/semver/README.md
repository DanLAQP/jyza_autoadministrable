...
Originally written as part of [composer/composer](REMOVED/composer/composer),
now extracted and made available as a stand-alone library.

[![Continuous Integration](REMOVED/composer/semver/actions/workflows/continuous-integration.yml/badge.svg?branch=main)](REMOVED/composer/semver/actions/workflows/continuous-integration.yml)
[![PHP Lint](REMOVED/composer/semver/actions/workflows/lint.yml/badge.svg?branch=main)](REMOVED/composer/semver/actions/workflows/lint.yml)
[![PHPStan](REMOVED/composer/semver/actions/workflows/phpstan.yml/badge.svg?branch=main)](REMOVED/composer/semver/actions/workflows/phpstan.yml)
...
The [`Composer\Semver\Comparator`](REMOVED/composer/semver/blob/main/src/Comparator.php) class provides the following methods for comparing versions:
...
The [`Composer\Semver\Semver`](REMOVED/composer/semver/blob/main/src/Semver.php) class provides the following methods:
...
The [`Composer\Semver\Intervals`](REMOVED/composer/semver/blob/main/src/Intervals.php) static class provides
