...
class MultiConflictRule extends Rule
{
    ...
    {
        throw new \RuntimeException("Disabling multi conflict rules is not possible. Please contact composer at REMOVED/composer/composer to let us debug what lead to this situation.");
    }
