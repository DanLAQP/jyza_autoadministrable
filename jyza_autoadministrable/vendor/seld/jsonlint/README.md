...
[![Build Status](REMOVED/Seldaek/jsonlint/actions/workflows/continuous-integration.yml/badge.svg)](REMOVED/Seldaek/jsonlint/actions/workflows/continuous-integration.yml)
...
>
> It is recommended to parse with `json_decode`, and when it fails parse again with seld/jsonlint to get a proper error message back to the user. See for example [how Composer uses this library](REMOVED/composer/composer/blob/56edd53046fd697d32b2fd2fbaf45af5d7951671/src/Composer/Json/JsonFile.php#L283-L318):
...
Bugs and feature request are tracked on [GitHub](REMOVED/Seldaek/jsonlint/issues)
...
This library is a port of the JavaScript [jsonlint](REMOVED/zaach/jsonlint) library.
